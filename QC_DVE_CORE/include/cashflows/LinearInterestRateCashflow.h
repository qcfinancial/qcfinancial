...
namespace QCode
{
	namespace Financial
	{
		...
		public:
			 ...
			 *
			 * @brief	Gets the fixing (or final rate) corresponding to the cashflow. Use this overload if all the
			 ...
			 *
			 * @brief	Gets the fixing (or final rate) corresponding to the cashflow. Use this overload if the
			 * interest depends on intermediate date fixings.
			 *
			 * @author	A Diaz V
			 * @date	19-03-2019
			 *
