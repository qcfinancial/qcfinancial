...
/*!
 * @brief La clase QCYearFraction es una clase abstracta. Al subclasearla se implementa
...
public:
    /*!
     * La función yf devuelve la fracción de año entre dos fechas. Es purely virtual.
     ...
     */
    virtual double yf(const QCDate& firstDate, const QCDate& secondDate) = 0;
    /*!
     ...
     */
    virtual long countDays(const QCDate& firstDate, const QCDate& secondDate) = 0;
};
