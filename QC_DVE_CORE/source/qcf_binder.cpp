...
PYBIND11_MODULE(qcfinancial, m) {
        ...
        py::enum_<QCDate::QCFxFixingLagAppliesTo>(m, "FxFixingLagAppliesTo")
                        .value("PUBLISHING_DATE", QCDate::qcPublishingDate)
                        .value("FIXING_DATE", QCDate::qcFixingDate);
        ...
        py::class_<QCAct360, shared_ptr<QCAct360>, QCYearFraction>(m, "QCAct360",
                        ...
                        .def(py::pickle(
                                // __getstate__: For a stateless class, we just return an empty tuple.
                                // This tells Python there is no internal state to save.
                                [](const QCAct360 &a) {
                                        return py::make_tuple();
                                },
                                // __setstate__: To reconstruct the object, we just create a new one
                                // using the default constructor. The input tuple is ignored.
                                [](py::tuple t) {
                                        return std::make_shared<QCAct360>();
                                }
                        ));
        ...
        py::class_<QCAct365, shared_ptr<QCAct365>, QCYearFraction>(m, "QCAct365")
                        ...
                        .def(py::pickle(
                                ...
                                // using the default constructor. The input tuple is ignored.
                                [](py::tuple t) {
                                        return std::make_shared<QCAct365>();
                                }
                        ));
        ...
        py::class_<QCAct30, shared_ptr<QCAct30>, QCYearFraction>(m, "QCAct30")
                        ...
                        .def(py::pickle(
                                ...
                                // using the default constructor. The input tuple is ignored.
                                [](py::tuple t) {
                                        return std::make_shared<QCAct30>();
                                }
                        ));
        ...
        py::class_<QCActAct, shared_ptr<QCActAct>, QCYearFraction>(m, "QCActAct")
                        ...
                        .def(py::pickle(
                                ...
                                // using the default constructor. The input tuple is ignored.
                                [](py::tuple t) {
                                        return std::make_shared<QCActAct>();
                                }
                        ));
        ...
        py::class_<QC30360, shared_ptr<QC30360>, QCYearFraction>(m, "QC30360")
                        ...
                        .def(py::pickle(
                                ...
                                // using the default constructor. The input tuple is ignored.
                                [](py::tuple t) {
                                        return std::make_shared<QC30360>();
                                }
                        ));
        ...
        py::class_<QCLinearWf, shared_ptr<QCLinearWf>, QCWealthFactor>(m, "QCLinearWf")
                        ...
                        .def(py::pickle(
                                // __getstate__: For a stateless class, return an empty tuple.
                                [](const QCLinearWf &a) {
                                        return py::make_tuple();
                                },
                                // __setstate__: To reconstruct, just create a new, default-constructed instance.
                                [](py::tuple t) {
                                        return std::make_shared<QCLinearWf>();
                                }
                        ));
        ...
        py::class_<QCCompoundWf, shared_ptr<QCCompoundWf>, QCWealthFactor>(m, "QCCompoundWf")
                        ...
                        .def(py::pickle(
                                // __getstate__: For a stateless class, return an empty tuple.
                                [](const QCCompoundWf &a) {
                                        return py::make_tuple();
                                },
                                // __setstate__: To reconstruct, just create a new, default-constructed instance.
                                [](py::tuple t) {
                                        return std::make_shared<QCCompoundWf>();
                                }
                        ));
        ...
        py::class_<QCContinousWf, shared_ptr<QCContinousWf>, QCWealthFactor>(m, "QCContinousWf")
                        ...
                        .def(py::pickle(
                                // __getstate__: For a stateless class, return an empty tuple.
                                [](const QCContinousWf &a) {
                                        return py::make_tuple();
                                },
                                // __setstate__: To reconstruct, just create a new, default-constructed instance.
                                [](py::tuple t) {
                                        return std::make_shared<QCContinousWf>();
                                }
                        ));
        ...
        py::class_<QCInterestRate>(m, "QCInterestRate")
                        ...
                        .def(py::pickle(
                                // __getstate__: Save the three constructor arguments.
                                [](const QCInterestRate &ir) {
                                        // Assuming getter methods exist for the rate, year fraction, and wealth factor.
                                        return py::make_tuple(ir.getValue(), ir.getYearFraction(),
                                                              ir.getWealthFactor());
                                },
                                // __setstate__: Reconstruct the object using the saved arguments.
                                [](py::tuple t) {
                                        if (t.size() != 3)
                                                throw std::runtime_error("Invalid state for QCInterestRate");

                                        // Extract the arguments from the tuple
                                        auto rate = t[0].cast<double>();
                                        auto yf = t[1].cast<shared_ptr<QCYearFraction> >();
                                        auto wf = t[2].cast<shared_ptr<QCWealthFactor> >();

                                        // Reconstruct the QCInterestRate object
                                        return QCInterestRate(rate, yf, wf);
                                }
                        ));
        ...
        // InterestRateIndex
        py::class_<qf::InterestRateIndex, qf::FinancialIndex, shared_ptr<qf::InterestRateIndex> >(
                                m, "InterestRateIndex")
                        .def(py::init<std::string,
                                QCInterestRate,
                                qf::Tenor,
        ...
        py::class_<qf::FXRateIndex, std::shared_ptr<qf::FXRateIndex>, qf::FinancialIndex>(m, "FXRateIndex")
                        ...
                        .def("publishing_date", &qf::FXRateIndex::publishingDate)
                        ...
                        .def("get_code", &qf::FXRateIndex::getCode);
        ...
        py::class_<qf::SimpleCashflow, qf::Cashflow, std::shared_ptr<qf::SimpleCashflow> >(m, "SimpleCashflow")
                        ...
                        .def("record", &qf::SimpleCashflow::record);
        ...
        py::class_<qf::SimpleMultiCurrencyCashflow, qf::SimpleCashflow, std::shared_ptr<
                        ...
                        .def("get_fx_rate_index_code", &qf::SimpleMultiCurrencyCashflow::getFXRateIndexCode)
        ...
        py::class_<qf::FixedRateCashflow, qf::Cashflow, std::shared_ptr<qf::FixedRateCashflow> >(m, "FixedRateCashflow")
                        ...
                        .def("record", &qf::FixedRateCashflow::record);
        ...
        py::class_<qf::FixedRateMultiCurrencyCashflow, std::shared_ptr<qf::FixedRateMultiCurrencyCashflow>,
                        ...
                        .def("accrued_interest_in_sett_ccy",
                             &qf::FixedRateMultiCurrencyCashflow::accruedInterestInSettCcy)
                        .def("get_amortization_in_sett_ccy",
                             &qf::FixedRateMultiCurrencyCashflow::getAmortizationInSettCcy)
        ...
        py::class_<qf::IborMultiCurrencyCashflow, std::shared_ptr<qf::IborMultiCurrencyCashflow>, qf::IborCashflow>(
                        ...
                        .def("settlement_currency_amount", &qf::IborMultiCurrencyCashflow::settlementCurrencyAmount)
        ...
        py::class_<qf::OvernightIndexCashflow, std::shared_ptr<qf::OvernightIndexCashflow>, qf::Cashflow>(
                        ...
                        .def("record", &qf::OvernightIndexCashflow::record);
        ...
        py::class_<qf::OvernightIndexMultiCurrencyCashflow, std::shared_ptr<qf::OvernightIndexMultiCurrencyCashflow>,
                        ...
                        .def("record", &qf::OvernightIndexMultiCurrencyCashflow::record)
        ...
        py::class_<qf::IcpClfCashflow, std::shared_ptr<qf::IcpClfCashflow>, qf::IcpClpCashflow>(
                        ...
                        .def("record", &qf::IcpClfCashflow::record)
        ...
        py::class_<qf::CompoundedOvernightRateMultiCurrencyCashflow2, std::shared_ptr<
                        ...
                        .def<
                                void(qf::CompoundedOvernightRateMultiCurrencyCashflow2::*)
                                (double)>(
                                "set_fx_rate_index_value",
                                &qf::CompoundedOvernightRateMultiCurrencyCashflow2::setFxRateIndexValue)
...
`num_threads` = 0 usa la concurrencia de hardware; el resultado no depende del número de threads.)pbdoc",
        ...
        py::enum_<QCDate::QCFxFixingLagPivot>(m, "FxFixingLagPivot")
                        .value("SETTLEMENT_DATE", QCDate::QCFxFixingLagPivot::qcSettlementDate)
        ...
        py::bind_vector<std::vector<long> >(m, "long_vec")
                        // Explicitly define the pickling methods
                        .def(py::pickle(
                                // __getstate__: Take the C++ vector and return a Python list
                                [](const std::vector<long> &v) {
                                        py::list list;
                                        for (long val: v) {
                                                list.append(val);
                                        }
                                        // Return a tuple containing the state (in this case, just the list)
                                        return py::make_tuple(list);
                                },
                                // __setstate__: Take the Python tuple and reconstruct the C++ vector
                                [](py::tuple t) {
                                        if (t.size() != 1) {
                                                throw std::runtime_error("Invalid state for long_vec");
                                        }
                                        // Extract the list from the tuple
                                        auto list = t[0].cast<py::list>();
                                        std::vector<long> v;
                                        for (auto item: list) {
                                                v.push_back(item.cast<long>());
                                        }
                                        return v;
                                }
                        ));
        ...
        py::class_<QCCurve<long>, std::shared_ptr<QCCurve<long> > >(m, "QCCurve")
                        ...
                        .def("get_abscissa", &QCCurve<long>::getAbscissa)
                        .def("get_ordinate", &QCCurve<long>::getOrdinate)
                        .def(py::pickle(
                                [](const QCCurve<long> &qc) {
                                        // __getstate__
                                        /* Return a tuple that fully encodes the state of the object */
                                        return py::make_tuple(qc.getAbscissa(), qc.getOrdinate());
                                },
                                [](py::tuple t) {
                                        // __setstate__
                                        if (t.size() != 2)
                                        ...
                                        auto abscissa(t[0].cast<vector<long> >());
                                        auto ordinate(t[1].cast<vector<double> >());

                                        /* Create a new C++ instance */
                                        QCCurve<long> qc(abscissa, ordinate);
        ...
        py::class_<QCLinearInterpolator, std::shared_ptr<QCLinearInterpolator>, QCInterpolator>(
                        ...
                        .def(py::pickle(
                                // __getstate__: returns the state of the object.
                                [](const QCLinearInterpolator &interpolator) {
                                        // The state is just the underlying QCCurve.
                                        return py::make_tuple(interpolator.getCurve());
                                },
                                // __setstate__: takes the state tuple and reconstructs the object.
                                [](py::tuple t) {
                                        if (t.size() != 1)
                                                throw std::runtime_error("Invalid state!");

                                        // Extract the QCCurve from the tuple
                                        auto curve = t[0].cast<std::shared_ptr<QCCurve<long> > >();

                                        // Reconstruct the QCInterpolator using the curve
                                        return std::make_shared<QCLinearInterpolator>(curve);
                                }
                        ));
        ...
        py::class_<qf::ZeroCouponCurve, std::shared_ptr<qf::ZeroCouponCurve>, qf::InterestRateCurve>(
                        ...
                        .def(py::pickle(
                                // __getstate__: Save the two constructor arguments.
                                [](const qf::ZeroCouponCurve &zcc) {
                                        // Assuming getter methods exist for the interpolator and the interest rate.
                                        return py::make_tuple(zcc.getInterpolator(), zcc.getInterestRate());
                                },
                                // __setstate__: Reconstruct the object using the saved arguments.
                                [](py::tuple t) {
                                        if (t.size() != 2)
                                                throw std::runtime_error("Invalid state for ZeroCouponCurve");

                                        // Extract the arguments from the tuple
                                        auto interpolator = t[0].cast<shared_ptr<QCInterpolator> >();
                                        auto ir = t[1].cast<QCInterestRate>();

                                        // Reconstruct the ZeroCouponCurve object
                                        return std::make_shared<qf::ZeroCouponCurve>(interpolator, ir);
                                }
                        ));
        ...
        py::class_<qf::PresentValueFX>(m, "PresentValueFX")
                        ...
                        .def("get_cip_settlement_curve_derivatives", &qf::PresentValueFX::getCipSettlementCurveDerivatives)
                        .def("get_discount_curve_derivatives", &qf::PresentValueFX::getDiscountCurveDerivatives)
